  ...
  <div class="app">
    <div class="container">
      <div class="clock">
        ...
        <div id="sec" class="inner-circle inner-circle-1">
          <div />
        </div>
        <div id="min" class="inner-circle inner-circle-2">
          <div />
        </div>
        <div id="hrs" class="inner-circle inner-circle-3">
          <div />
        </div>
...
<style scoped>
  ...
  .clock {
    ...
    position: relative;
    -webkit-box-shadow:
      inset inset 0px 0px 12px 12px rgba(0, 0, 0, 1),
      0px 0px 65px 5px rgba(0, 0, 0, 0.5);
    -moz-box-shadow:
      inset inset 0px 0px 12px 12px rgba(0, 0, 0, 1),
      0px 0px 65px 5px rgba(0, 0, 0, 0.5);
    box-shadow:
      inset 0px 0px 12px 12px rgba(0, 0, 0, 1),
      0px 0px 65px 5px rgba(0, 0, 0, 0.5);
    background: #1a1c1a;
    display: flex;
    justify-content: center;
